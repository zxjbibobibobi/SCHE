...
dataset2eps = {
    'credit': 10.399,# kdn 5, n_neighbor 4
    'kddcup99_probe': 0.4739394009858889,
    'kddcup99_r2l': 0.37301618438223577,
    'payment_simulation': 8296
}
                    ...
                    with trange(runs, ncols=80) as t:
                        ...
                        for run_index in t:
                            ...
                            baseline = self_paced_curriculum_ensemble.SelfPacedCurriculumEnsemble(
                                ...
                                # path="D:/研究生/研一/Project/SPHE/kdn_cache/"+d_name+'/',
                                os_flag=True
                            )
